...
<div class="worker-portal-admin-dashboard">
    ...
    $(document).ready(function() {
        $('#add-new-worker').click(function() {
            // Lógica para abrir el modal de agregar nuevo trabajador
            $('#add-new-worker-modal').show();
        }); 
        $('#add-new-worker-modal .worker-portal-modal-close').click(function() {
            $('#add-new-worker-modal').hide();
        });
        $('#add-new-worker-modal .worker-portal-modal-cancel').click(function() {
            $('#add-new-worker-modal').hide();
        });
        $('#add-new-worker-modal .worker-portal-modal-save').click(function() {
            // Lógica para guardar el nuevo trabajador
            // ...
            $('#add-new-worker-modal').hide();
        });
        $('#delete-selected-workers').click(function() {
            // Lógica para eliminar trabajadores seleccionados
            // ...
        });
        $('#delete-selected-incentives').click(function() {
            // Lógica para eliminar incentivos seleccionados
            // ...
        });
        $('#delete-selected-documents').click(function() {
            // Lógica para eliminar documentos seleccionados
            // ...
        });
        $('#delete-selected-expenses').click(function() {
            // Lógica para eliminar gastos seleccionados
            // ...
        });
        $('#delete-selected-worksheets').click(function() {
            // Lógica para eliminar hojas de trabajo seleccionadas
            // ...
        });
        $('#upload-new-document').click(function() {
            // Lógica para abrir el modal de subir nuevo documento
            $('#upload-new-document-modal').show();
        });
        $('#upload-new-document-modal .worker-portal-modal-close').click(function() {
            $('#upload-new-document-modal').hide();
        });
        $('#upload-new-document-modal .worker-portal-modal-cancel').click(function() {
            $('#upload-new-document-modal').hide();
        });
        $('#upload-new-document-modal .worker-portal-modal-save').click(function() {
        ...
        $('#approve-selected-expenses').click(function() {
            // Lógica para aprobar gastos seleccionados
            // ...
        }); 
        $('#approve-selected-worksheets').click(function() {
            // Lógica para aprobar hojas de trabajo seleccionadas
            // ...
        });
        $('#approve-selected-documents').click(function() {
            // Lógica para aprobar documentos seleccionados
            // ...
        });
        $('#approve-selected-incentives').click(function() {
            // Lógica para aprobar incentivos seleccionados
            // ...
        });
        $('#approve-selected-workers').click(function() {
            // Lógica para aprobar trabajadores seleccionados
            // ...
        });
        $('#approve-selected-expenses').click(function() {
            // Lógica para aprobar gastos seleccionados
